...
<template>
  <div class="home-renter">
    <div class="home-renter-header">
      <h2>Home</h2>
      <div class="option">
        <OptionIcon />
      </div>
      ...
      <CTabContent>
        ...
        >
          ...
          <div class="btn-apply-wrapper">
            <WButton color="primary" text="Apply for Loan"></WButton>
          </div>
          <div class="home-renter-banner">
            <HomeRenterBannerIcon />
          </div>
        </CTabPane>
        <CTabPane
          role="tabpanel"
        ...
        >
          <div class="loan-application-container">
            <div class="loan-application-item">
              <div class="loan-application-info">
                <div class="loan-image">
                  <HomeIcon />
                </div>
                <div class="loan-application-info-detail">
                  <h6>Loan #11223</h6>
                  <p>14000 SAR</p>
                  <p class="waiting">Waiting Owner Signiture</p>
                </div>
              </div>
            </div>
          </div>
...
.nav-link.active {
  ...
  line-height: 20px;
  color: #100d40;
  border-bottom: 4px solid #100d40 !important;
}
.loan-item {
  width: 100%;
...
.loan-info-detail h6,
.loan-application-info-detail h6 {
  margin: 0;
  font-weight: 500;
  font-size: 14px;
  line-height: 20px;
...
.loan-info-detail p,
.loan-application-info-detail p {
  margin: 0;
  font-weight: 400;
  font-size: 12px;
  line-height: 18px;
